...
\faLightbulbO \quad \fbox{\textbf{Discutez}} L'astuce est de commencer par trouver la valeur de la limite de cette suite récurrente. A sa limite, cette suite est censée stagner, soit:
\begin{equation}
    x_n = \frac{x_n + 1}{2},
\end{equation}
